# This file is now managed by chezmoi
...
# activate the shell command auto suggestions
...
# remove the user name from shell prompt
prompt_context() {}
...
# setting for specific version of node
